...
export default function CreateVendor() {
  ...
  const validate = () => {
    ...
    // SLA days validation for checked services
  ...
  <div className="flex flex-col h-[92vh] px-6 py-5">
    ...
    <div className="flex-1 overflow-y-auto">
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-7 max-w-3xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label={<>Coverage Area (States) <span className="text-red-500">*</span></>} error={errors.states}>
              <input
                ...
                className={inputClass(errors.states)}
              />
            </Field>
            <Field label={<>Coverage Area (Cities) <span className="text-red-500">*</span></>} error={errors.cities}>
              <input
                ...
                className={inputClass(errors.cities)}
              />
            </Field>
          </div>
        </div>
        ...
        <div className="space-y-4 -mt-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Field label={<>Contact Email <span className="text-red-500">*</span></>} error={errors.email}>
              <input
                type="email"
                value={form.email}
            ...
            <Field label={<>Phone Number <span className="text-red-500">*</span></>} error={errors.phone}>
              <input
                value={form.phone}
    ...
    {/* BUTTONS — always visible below card, aligned right */}
